...
path='C:\Users\Luethi\Documents\Dropbox\PTV_working_folders\JMC_Oct_26\';

exp=['2000fps_2Hz_rec2'];
img_folder=['img_2Hz_rec2/'];
res_folder=['res_2Hz_rec2/'];
cal_folder=['cal1/'];
...
max_vel=2.0;                                     %[m/s] <-----TUNING
tol_vz=0.6;                                      %[m/s] <-----TUNING
...
% load(name_traj);
% compute_holes();
% render_traj_figures(2,246,30,0.08);
